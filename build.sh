...
TOOLCHAIN=proton # List ( gcc = eva | aospa | nexus9 | nexus12 ) (clang = atomx | aosp | sdclang | proton )
LINKER=ld # List ( ld.lld | ld.bfd | ld.gold | ld )
VERBOSE=0
ZIPNAME=Nexus-Xtreme-X2-beta
FINAL_ZIP=${ZIPNAME}-${DRONE_BUILD_NUMBER}.zip
